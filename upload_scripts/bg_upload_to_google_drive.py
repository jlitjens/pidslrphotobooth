...
Forked from https://github.com/MartinStolle/pi-upload-google-drive
'''
import configparser
import datetime
import logging
...
class GoogleDrive:
    ...
    def upload_image(self, filename, parents=None):
        ...
        if file_extension == ".jpg":
            ...
            self.logger.info("Don't know mimetype for this file_extension: %s", file_extension)
            mime = 'image/jpeg'
...
class Configuration:
    ...
    filename = os.path.join(os.getcwd(), "bg_upload_to_google_drive.config")
...
class ImageUpload:
    ...
    def upload_newest_images(self):
        ...
        if to_upload > 0:
            ...
            self.logger.info("of which [%s] needed to be uploaded to Google Drive", to_upload)
        # else:
        #     self.logger.info("No new images to upload to Google Drive")
...
def init_logging():
    ...
    logging.basicConfig(level=logging.INFO,
                        filename='bg_upload_to_google_drive.log',
                        filemode='w')
